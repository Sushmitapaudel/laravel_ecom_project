        ...
        <div class="row">
            ...
            <div class="col-md-5 ">
                <div id="product-main-img">
                    <div class="product-preview">
                        <img src="../uploads/products/{{$product->id}}/{{$product->image_name}}"  style="height:300px;width:250px;object-fit:cover"  alt="">
                    </div>
                </div>
            </div>
            <!-- /Product main img -->
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price">Rs {{$product->discount}} <del class="product-old-price">Rs{{$product->price}}</del></h3>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="product">
                            <div class="product-img">
                                <img src="uploads/products/{{$pro->id}}/{{$pro->image_name}}"  style="height:300px;width:250px;object-fit:cover" alt="">
                                <div class="product-label">
                                    <span class="sale">offer</span>
                                    <span class="new">{{$pro->tag}}</span>
                                </div>
                            </div>
                            <div class="product-body">
                                <h3 class="product-name"><a href="product/{{$pro->id}}">{{$pro->name}}</a></h3>
                                <h4 class="product-price">Rs {{$pro->discount}} <del class="product-old-price">Rs {{$pro->price}}</del></h4>
                                <div class="product-rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="add-to-cart">
                                <a class="add-to-cart-btn" href="{{route('user.view',['id'=>$pro->id])}}"><i class="fa fa-shopping-cart"></i>Purchase</a>
                            </div>
                        </div>
