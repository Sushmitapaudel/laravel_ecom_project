        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> 9864031423</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i>sabjighar4@gmail.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i>sanepa-6-kathmandu</a></li>
                </ul>
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="{{route('user.home')}}" class="logo">
                                <img src="{{asset('img/log.png')}}" alt="" height="100px" width="100px">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="./img/shop0{{$index++}}.png"  style="height:250px;width:400px;object-fit:cover" alt="">
                        </div>
                        <div class="shop-body">
                            <h3>{{$c->name}}</h3>
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>Welcome to Sabjighar.We're glad and grateful you're here.We serve you healthy and hygenic vegetables along with their benefits.</p>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                ...
                                <li><a href="#">Potatoes and pumpkins</a></li>
                                <li><a href="#">Tomatoes</a></li>
                                <li><a href="#">capsicum and mushroom</a></li>
                                <
                            </ul>
                        </div>
                    </div>
