...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} Rs</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>The product Will be delivered within 2 hour of confirmation. We accept only Cash on delivery at this moment.</p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" Rs";
                document.getElementById("totalCost").innerHTML = msg[2]+" Rs";
            }
            });
